...
def get_MAC(interface, target_IP):
    ...
    macs = ['78:24:af:dc:ae:76','00:00:0c:9f:f0:00']
    dict = {}
    dict["129.31.93.54"] = macs[0]
    dict["129.31.92.1"] = macs[1]
    if target_IP in dict:
        return dict[target_IP]
...
def main():
    ...
    macs = ['00-00-0c-9f-f0-00','78-24-AF-DC-AE-76']

    dict = {}
    dict["129.31.92.1"] = macs[0]
    dict["129.31.93.54"] = macs[1]
